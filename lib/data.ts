...
export const tattooStyles: TattooStyle[] = [
  {
    ...
    description: "Photorealistic portraits and life-like designs that capture every detail. Our specialty in capturing human and animal portraits.",
    image: "/tattoos/5.jpeg",
    priceRange: "₹500/inch",
  },
  {
    id: "religious",
    name: "Religious / Spiritual",
    description: "Devotional tattoos including Mahadev, Om, Mahakal, and Sanskrit scripts. Beautifully crafted spiritual symbols.",
    image: "/tattoos/3.jpeg",
    priceRange: "₹500/inch",
  },
  {
    id: "mandala",
    name: "Mandala Art",
    description: "Intricate mandala and geometric patterns representing the universe. Perfect for spiritual and aesthetic balance.",
    image: "/tattoos/1.jpeg",
    priceRange: "₹500/inch",
  },
  {
    id: "band",
    name: "Armbands / Band",
    description: "Maori, Polynesian, and Geometric bands for arms and wrists. Strong, bold patterns that flow with your anatomy.",
    image: "/tattoos/2.jpeg",
    priceRange: "₹500/inch",
  },
  {
    id: "minimalist",
    name: "Minimalist / Tiny",
    description: "Small, meaningful symbols and fine-line tattoos. Subtle yet powerful expressions of your personality.",
    image: "/tattoos/4.jpeg",
    priceRange: "₹500/inch",
  },
  {
    id: "watercolor",
...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Pricing depends on size, complexity, style, placement, and the artist. Our rates start from ₹500/inch. Small pieces may have a minimum charge. We provide free enquiry where we'll give you an accurate quote based on your specific design. Use our Price Estimator tool for a quick ballpark estimate!",
    category: "pricing",
  },
  {
    id: "faq-6",
...
export const tattooSizes = [
  { id: "tiny", label: "Tiny (1 inch)", basePrice: 500, timeEstimate: "30-60 min" },
  { id: "small", label: "Small (2-4 inches)", basePrice: 1500, timeEstimate: "1-2 hours" },
  { id: "medium", label: "Medium (4-6 inches)", basePrice: 2500, timeEstimate: "2-4 hours" },
  { id: "large", label: "Large (6-10 inches)", basePrice: 4000, timeEstimate: "4-6 hours" },
